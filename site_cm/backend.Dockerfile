...
RUN echo "version: 2023.11.22 2105"; bench get-app site_cm --branch version-15 https://github.com/developmentforpeople/site_cm; bench setup requirements site_cm;