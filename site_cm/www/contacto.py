...
def send_message(sender, message, subject="Website Query"):
	...
	with suppress(frappe.OutgoingEmailError):
		...
		frappe.sendmail(
			recipients=sender,
			content=f"""<div style='white-space: pre-wrap'>{_("Thank you for reaching out to us. We will get back to you at the earliest.")}\n\n\n{_("Your query:")}\n\n{message}</div>""",
			subject=_("Hemos recibido tu solicitud "),
		)
